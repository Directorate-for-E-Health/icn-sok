...
export const MaalAutosuggest = class MaalAutosuggest extends React.Component {
  constructor() {
    super();
  ...
  fetchSuggestions = (value) => {
    ...
    let getTermsUrl =
      ...
      "term=" +
      term +
      "&conceptRefset=138461000202105&active=true&conceptActive=true&groupByConcept=true&offset=0&limit=10";
...
export default MaalAutosuggest;
